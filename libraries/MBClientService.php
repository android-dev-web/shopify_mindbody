...
class MBClientService extends MBAPIService 
{
	...
	public function SendUserNewPassword($userEmail, $userFirstName = '', $userLastName = "",  $PageSize = null, $CurrentPage = null, $XMLDetail = XMLDetail::Full, $Fields = null, SourceCredentials $credentials = null)
	{
		$additions['UserEmail'] = $userEmail;
		if ($userFirstName != '')
		{
			$additions['UserFirstName'] = $userFirstName;
		}
		if ($userLastName != '')
		{
			$additions['UserLastName'] = $userLastName;
		}
		$params = $this->GetMindbodyParams($additions, $this->GetCredentials($credentials), $XMLDetail, $PageSize, $CurrentPage, $Fields);
